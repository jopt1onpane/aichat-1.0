...
public class ChromaticAberrationDirection : MonoBehaviour
{
	[SerializeField]
	...
	public void Setup(DirectionService directionService)
	{
		...
		_powerRatio.Subscribe(delegate(float ratio)
		{
			...
			_directionService.ChangeActiveRenderFeature(DirectionService.RenderFeatureType.ColorGlitch, ratio != 0f);
		}).AddTo(this);
	}
