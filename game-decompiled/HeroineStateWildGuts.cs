...
public class HeroineStateWildGuts : HeroineBaseState
{
	...
	{
		base.Owner.HeroineService.ChangeAnimation(HeroineService.AnimationType.Wild001_Motion4_Guts);
	}
	...
	{
		await WaitWithTimeout(() => base.Owner.HeroineService.IsEndAnimation(HeroineService.AnimationType.Wild001_Motion4_Guts.ToString()), 20f, token);
	}
