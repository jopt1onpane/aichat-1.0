...
public class HeroineStateFromReportToBook : HeroineBaseState
{
	...
	{
		base.Owner.HeroineService.ChangeAnimation(HeroineService.AnimationType.Wild002_FromReportToBook);
	}
	...
	{
		await WaitWithTimeout(() => base.Owner.HeroineService.IsEndAnimation(HeroineService.AnimationType.Wild002_FromReportToBook.ToString()), 10f, token);
	}
