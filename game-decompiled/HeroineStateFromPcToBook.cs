...
public class HeroineStateFromPcToBook : HeroineBaseState
{
	...
	{
		base.Owner.HeroineService.ChangeAnimation(HeroineService.AnimationType.Wild002_FromPcToBook);
	}
	...
	{
		await WaitWithTimeout(() => base.Owner.HeroineService.IsEndAnimation(HeroineService.AnimationType.Wild002_FromPcToBook.ToString()), 10f, token);
	}
