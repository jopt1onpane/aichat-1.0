...
public class HeroineStateFromBookToPc : HeroineBaseState
{
	...
	{
		base.Owner.HeroineService.ChangeAnimation(HeroineService.AnimationType.Wild002_FromBookToPc);
	}
	...
	{
		await WaitWithTimeout(() => base.Owner.HeroineService.IsEndAnimation(HeroineService.AnimationType.Wild002_FromBookToPc.ToString()), 10f, token);
	}
