...
public class HeroineStateWildStretchShoulder : HeroineBaseState
{
	...
	{
		base.Owner.HeroineService.ChangeAnimation(HeroineService.AnimationType.Wild001_Motion2_StretchShoulder);
	}
	...
	{
		await WaitWithTimeout(() => base.Owner.HeroineService.IsEndAnimation(HeroineService.AnimationType.Wild001_Motion2_StretchShoulder.ToString()), 20f, token);
	}
