...
public class FacilityManagerForMobile : MonoBehaviour, ILevelUpDirectionController, IPomodoroTalkController, IDebugRoomGameManager, IStoryController, IMusicPlayerController
{
	[SerializeField]
