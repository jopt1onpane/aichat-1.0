...
public class ScenarioAmbientBGMManager : AudioManager<ScenarioAmbientBGMManager>
{
	...
	{
		GameObject gameObject = new GameObject("ScenarioAmbientBGMManager", typeof(ScenarioAmbientBGMManager));
		ScenarioAmbientBGMManager instance = gameObject.GetComponent<ScenarioAmbientBGMManager>();
